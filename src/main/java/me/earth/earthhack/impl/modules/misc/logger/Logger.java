...
//        this.listeners.add(new ListenerPb2Client(this));
    ...
    {
        String simpleName = FabricLoader.getInstance().getMappingResolver().unmapClassName("intermediate", packet.getClass().getSimpleName());
    ...
    private String getName(Field field)
    {
        ...
        {
            String name = FabricLoader.getInstance().getMappingResolver().unmapClassName("intermediate", field.getName());
            if (name != null)
            {
                return name;
            }
