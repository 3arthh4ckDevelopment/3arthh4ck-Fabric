...
public class Announcer extends Module
{
    ...
    /** KA and AC targets. */
    protected final Set<PlayerEntity> targets = new HashSet<>();
    /** Timer to handle delay. */
    protected final StopWatch timer = new StopWatch();
    /** Handles distance we travelled. */
    double travelled;
    /** Tracks arrows and their targets to announce misses */
    protected final Map<Integer, PlayerEntity> arrowMap = new ConcurrentHashMap<>();
    ...
    {
        return switch (type) {
            case Distance -> distance.getValue();
            case Mine -> mine.getValue();
            case Place -> place.getValue();
            case Eat -> eat.getValue();
            case Join -> join.getValue();
            case Leave -> leave.getValue();
            case Totems -> totems.getValue();
            case Death -> autoEZ.getValue();
            case Miss -> miss.getValue();
        };
    }
