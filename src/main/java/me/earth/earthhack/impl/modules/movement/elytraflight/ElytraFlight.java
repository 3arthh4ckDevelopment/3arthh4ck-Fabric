...
public class ElytraFlight extends Module
{
    protected final Setting<ElytraMode> mode   =
            register(new EnumSetting<>("Mode", ElytraMode.Packet));
    ...
    /**
     * Sends a {@link ClientCommandC2SPacket}, with parameters mc.player and
     * {@link ClientCommandC2SPacket.Mode#START_FALL_FLYING}.
     */
