    ...
    public void invoke(MotionUpdateEvent event)
    {
            ...
            && module.mode.getValue() != Mode.Compatibility)
        {
            ...
            for (int i = 1; i <= (module.mode.getValue() == Mode.Factor
                                    ...
                                    : 1); i++)
            {
                double conceal = mc.player.getY() < module.concealY.getValue()
                        && !MovementUtil.noMovementKeys()
                            ? module.conceal.getValue()
                            : 1.0;

                mc.player.setVelocity(
                        dirSpeed[0] * i * conceal * module.xzSpeed.getValue(),
                        ySpeed * i * module.ySpeed.getValue(),
                        dirSpeed[1] * i * conceal * module.xzSpeed.getValue());
