...
public class GuiUtil {
    ...
    public static boolean isHovered(HudElement element, double mouseX, double mouseY) {
        return isHovered(element.getX(), element.getY(), element.getWidth(), element.getHeight(), mouseX, mouseY);
    }

    public static boolean isHovered(Frame element, double mouseX, double mouseY) {
