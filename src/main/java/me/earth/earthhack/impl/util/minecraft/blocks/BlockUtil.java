...
public class BlockUtil implements Globals
{
     ...
     * @return {@link Entity#squaredDistanceTo(Vec3d)}.
     */
    ...
    {
        double x = from.getX() - (to.getX() + 0.5);
        double y = from.getY() - (to.getY() + 0.5) + 1.5;
        double z = from.getZ() - (to.getZ() + 0.5);
        return x * x + y * y + z * z;
    }
    ...
    public static boolean isSemiSafe(PlayerEntity player,
                                     boolean ignoreCrystals,
                                     boolean noBoost2)
    {
    ...
    public static boolean canBeFeetPlaced(PlayerEntity player,
                                          boolean ignoreCrystals,
                                          boolean noBoost2)
    {
    ...
    public static boolean isAtFeet(List<PlayerEntity> players,
                                   BlockPos pos,
                                   boolean ignoreCrystals,
                                   boolean noBoost2)
    {
     ...
     */
    public static boolean isAtFeet(PlayerEntity player,
                                   BlockPos pos,
                                   boolean ignoreCrystals,
                                   boolean noBoost2)
    {
     ...
     * @return {@link BlockUtil#getFacing(BlockPos, ClientWorld)}
