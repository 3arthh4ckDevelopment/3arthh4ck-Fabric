...
public class DistanceUtil {
    ...
    public static double distanceSq2Crystal(BlockPos pos, Entity entity) {
        return distanceSq(pos.getX() + 0.5f, pos.getY() + 1, pos.getZ() + 0.5f, entity.getX(), entity.getY(), entity.getZ());
    }
    ...
    public static double distanceSq(double x, double y, double z, Entity entity) {
        return distanceSq(x, y, z, entity.getX(), entity.getY(), entity.getZ());
    }
