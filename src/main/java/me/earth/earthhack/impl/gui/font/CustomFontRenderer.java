...
public class CustomFontRenderer extends CustomFont
{
                            ...
                            boolean shadow)
    {
        ...
        */
        ...
        GlStateManager._bindTexture(tex.getGlTextureId());
        ...
        for (int i = 0; i < text.length(); i++)
        {
            ...
            if (character == TextColor.SECTIONSIGN && i + 1 < text.length())
            {
                ...
                else if (colorIndex == 17)
                {
                    ...
                    if (italic)
                    {
                        GlStateManager._bindTexture(texBoth.getGlTextureId());
                        currentData = this.boldItalicChars;
                    }
                    else
                    {
                        GlStateManager._bindTexture(texBold.getGlTextureId());
                ...
                else if (colorIndex == 20)
                {
                    ...
                    {
                        GlStateManager._bindTexture(texItalic.getGlTextureId());
