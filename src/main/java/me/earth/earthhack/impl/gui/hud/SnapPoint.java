...
public class SnapPoint
{
    ...
    public void draw(DrawContext context) {
        ...
        {
            Render2DUtil.drawLine(context.getMatrices(), off, location, off + size, location, 1.0f, Color.WHITE.getRGB());
        }
        else if (orientation == Orientation.LEFT
                || orientation == Orientation.RIGHT
                || orientation == Orientation.VERTICAL_CENTER)
        {
            Render2DUtil.drawLine(context.getMatrices(), location, off, location, off + size, 1.0f, Color.WHITE.getRGB());
        }
    }
